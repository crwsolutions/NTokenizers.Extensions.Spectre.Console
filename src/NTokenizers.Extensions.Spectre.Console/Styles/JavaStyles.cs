...
/// <summary>
/// Provides predefined styles for Java syntax highlighting in Spectre.Console.
/// </summary>
public sealed class JavaStyles
{
    /// <summary>
    /// Gets the default Java styles.
    /// </summary>
    public static JavaStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for double colon '::' (method reference).
    /// </summary>
    public Style DoubleColon { get; set; } = new Style(Color.Yellow);

    /// <summary>
    /// Gets or sets the style for question mark '?' (ternary operator).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the style for identifiers including variable names, method names, etc.
    /// </summary>
    public Style Identifier { get; set; } = new Style(Color.White);

    /// <summary>
    /// Gets or sets the style for Java keywords.
    /// </summary>
