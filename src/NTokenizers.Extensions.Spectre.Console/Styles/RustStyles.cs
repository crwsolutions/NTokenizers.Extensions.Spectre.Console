...
/// <summary>
/// Provides predefined styles for Rust syntax highlighting in Spectre.Console.
/// </summary>
public sealed class RustStyles
{
    /// <summary>
    /// Gets the default Rust styles.
    /// </summary>
    public static RustStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for double colon '::' (namespace separator).
    /// </summary>
    public Style DoubleColon { get; set; } = new Style(Color.Yellow);

    /// <summary>
    /// Gets or sets the style for fat arrow '=>' operators.
    /// </summary>
    public Style FatArrow { get; set; } = new Style(Color.DeepSkyBlue4_2);

    /// <summary>
    /// Gets or sets the style for arrow '->' operators.
    /// </summary>
    public Style Arrow { get; set; } = new Style(Color.DeepSkyBlue4_2);
    ...
    /// <summary>
    /// Gets or sets the style for lifetime annotations (e.g., 'a).
    /// </summary>
    public Style Lifetime { get; set; } = new Style(Color.Magenta);
    ...
    /// <summary>
    /// Gets or sets the style for Rust keywords.
    /// </summary>
