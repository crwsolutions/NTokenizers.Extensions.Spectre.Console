...
/// </summary>
public sealed class CStyles
{
    /// <summary>
    /// Gets the default C styles.
    /// </summary>
    public static CStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for preprocessor directives (#include, #define, etc.).
    /// </summary>
    public Style Preprocessor { get; set; } = new Style(Color.Magenta);
