...
/// </summary>
public sealed class CppStyles
{
    /// <summary>
    /// Gets the default C++ styles.
    /// </summary>
    public static CppStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for double colon '::' (scope resolution).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the style for null values (nullptr, NULL).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the style for C++ keywords.
    /// </summary>
