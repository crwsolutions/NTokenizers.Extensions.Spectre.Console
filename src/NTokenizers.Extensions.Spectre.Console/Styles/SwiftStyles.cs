...
/// <summary>
/// Provides predefined styles for Swift syntax highlighting in Spectre.Console.
/// </summary>
public sealed class SwiftStyles
{
    /// <summary>
    /// Gets the default Swift styles.
    /// </summary>
    public static SwiftStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for Swift keywords.
    /// </summary>
