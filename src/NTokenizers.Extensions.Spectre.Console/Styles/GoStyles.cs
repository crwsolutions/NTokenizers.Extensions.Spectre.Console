...
/// <summary>
/// Provides predefined styles for Go syntax highlighting in Spectre.Console.
/// </summary>
public sealed class GoStyles
{
    /// <summary>
    /// Gets the default Go styles.
    /// </summary>
    public static GoStyles Default => new();
    ...
    /// <summary>
    /// Gets or sets the style for string values enclosed in double quotes or backticks.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the style for null values (nil).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the style for Go keywords.
    /// </summary>
